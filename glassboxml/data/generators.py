...
def generate_classification_dataset(
    ...
    #Applies sigmoid function to get probabilities and then thresholds at 0.5 to get binary labels
    y = (1 / (1 + np.exp(-linear_output)) >= 0.5).astype(int)
